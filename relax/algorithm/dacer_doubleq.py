...
class DACERDoubleQ(Algorithm):

    def __init__(
        self,
        agent: DACERDoubleQNet,
        params: DACERDoubleQParams,
        *,
        gamma: float = 0.99,
        lr: float = 1e-4,
        ...
        def stateless_update(
            ...
            def policy_loss_fn(policy_params) -> jax.Array:
                ...
                q1_mean = self.agent.q(q1_params, obs, new_action)
                q2_mean = self.agent.q(q2_params, obs, new_action)
            ...
            state = DACERTrainState(
                params=DACERDoubleQParams(q1_params, q2_params, target_q1_params, target_q2_params, policy_params, log_alpha),
