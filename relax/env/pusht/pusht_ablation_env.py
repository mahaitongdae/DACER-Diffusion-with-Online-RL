...
class PushTSparseCurriculumEnv(PushTSparseEnv):
...
class PushTShpEnv(PushTSparseEnv):
    metadata = {"render.modes": [
        "human", "rgb_array"], "video.frames_per_second": 10}
    shapes = ['tee', 'cee', 'lee']
    masks = {
...
class PushTShpSparseCurriculumEnv(PushTSparseCurriculumEnv):
    metadata = {"render.modes": [
        "human", "rgb_array"], "video.frames_per_second": 10}
    shapes = ['tee', 'cee', 'lee']
    masks = {
...
if __name__ == "__main__":
    ...
    env = gym.make('pushtcurriculum_sparse-v0')
